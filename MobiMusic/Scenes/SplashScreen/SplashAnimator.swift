...
final class SplashAnimator: SplashAnimatorDescription {
    ...
    func animateAppearance() {
        ...
        UIView.animate(withDuration: 0.3, animations: {
          self.foregroundSplashViewController.logoImageView.transform = CGAffineTransform(scaleX: 128 / 115.2, y: 100 / 95)
        })
    }
...
//        }
      ...
      guard let windowScene = UIApplication.shared.connectedScenes.first as? UIWindowScene, let sceneDelegate = windowScene.delegate as? SceneDelegate, let mainWindow = sceneDelegate.window else {
          fatalError("Application doesn't have a window!")
      }
